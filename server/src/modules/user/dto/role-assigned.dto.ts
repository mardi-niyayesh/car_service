...
export class UserRoleAssignedForbiddenRes extends getNormalErrorResponse({
  ...
  You don't have OWNER privileges required to assign permission affecting management-level roles 
  (owner.all, user.view, user.delete, role.assign, role.revoke, role.create, role.view, role.update, role.delete).`,
  statusCode: 403,
