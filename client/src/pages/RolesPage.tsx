    ...
    <>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-md p-4 mb-6 mt-6">
        ...
        <ul className="list-disc pr-5 space-y-1 text-sm text-gray-700 ">
          ...
          <li>
            حتی اگر یکی از رول ها نقش حساس داشته باشد ( با user/role) شروع شده
            باشد و با داشتن مجوز role.deleat نمیتوانید حذفش کنید فقط owner قادر
            به حذف نقش های کاستوم حساس می باشد
          </li>
        </ul>
      </div>
    </>
