  ...
  useEffect(() => {
    const fetchBasket = async () => {
      try {
        ...
        const Data = resBasket.data.response.data.cart;
        const GetDataBasket = Data.carRents;
        const fetchId = Data.cart_id;
        console.log("id payment :", fetchId);
    ...
    <>
      <div>
        {Databasket?.map((data) => (
          <div
            key={data.id}
            className="mt-4 border-b py-3.5 border-gray-300 w-full"
          >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-2">
                    <span className="text-gray-600 ml-1 text-[18px]">
                      اسم ماشین :
                    </span>
