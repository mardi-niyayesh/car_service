...
const detail = [
  {
    icon: <GiTowTruck size={100} className="text-blue-400" />,
    title: "امداد رسانی در کمتر از 30 دقیقه در هر جای ایران ",
    text: `
                شبکه تحت پوشش ناواران، که با همکاری شرکای تجاری در خدمت مشتریان قرار گرفته است، شامل 2000 نقطه در سراسر
  ...
  {
    icon: <AiFillCar size={100} className="text-blue-400" />,
    title: "ارائه ماشین های همیشه تمیز و نو",
    text: `
                یکی از دلایل موفقیت و محبوبیت خودروهای ناواران، نو و تمیز بودن خودروهاست، هر خودرو بعد از هر اجاره سرویس
  ...
  {
    icon: <GiDart size={100} className="text-blue-400" />,
    title: "رزرو رایگان با امتیاز",
    text: `
                مشترکین ناواران می‌توانند با انجام رزرو برای دوستان و همکاران خود، امتیاز رزروهای ایشان را در کاربر خود
  ...
  {
    icon: <FaFileInvoiceDollar size={100} className="text-blue-400" />,
      ...
      {detail.map((item, index) => (
        ...
        >
          ...
          <div
            ...
            className="flex items-center justify-between text-sm font-medium text-blue-600 hover:text-blue-800 cursor-pointer"
          >
