...
const ComponentDes = ({
  ...
  return (
    <div >
      ...
      <p className="text-gray-600 mb-6 text-sm leading-relaxed">{destitle}</p>
        ...
        <div className="space-y-6">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <p className="mt-3 pr-4 text-gray-600 space-y-1 text-sm leading-relaxed">{plan.description}</p>
            </div>
          ))}
        </div>
      )}
